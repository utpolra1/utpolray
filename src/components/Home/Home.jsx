...
const Home = () => {
  return (
    <div className="lg:py-24 flex flex-col lg:flex-row items-center pt-8 mt-8 justify-center lg:justify-between bg-gradient-to-r from-indigo-900 to-purple-900 px-10 shadow-lg">
